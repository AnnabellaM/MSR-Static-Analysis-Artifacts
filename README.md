...
#### RQ3
The results of the manual analysis performed on the 60 issues are located in the `data/RQ3/` directory. It contains the results of the manual analysis performed on the issues, including the ID, Group, Topic, Final 5 Examples, Problem, Root Cause, Response Type, and Response. The results are stored in the `RQ3_Manual_Analysis.csv` file.
